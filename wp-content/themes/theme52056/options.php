...
// Fonts
			...
			$typography_mixed_fonts["Sacramento, cursive"] = "Sacramento *";
...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#969696'));
								
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '30px', 'lineheight' => '35px', 'face' => 'Comfortaa', 'style' => 'bold', 'character'  => 'latin', 'color' => '#333333'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '22px', 'lineheight' => '22px', 'face' => 'Comfortaa', 'style' => 'bold', 'character'  => 'latin', 'color' => '#333333'));
								
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '24px', 'lineheight' => '29px', 'face' => 'Comfortaa', 'style' => 'bold', 'character'  => 'latin', 'color' => '#333333'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => 'Comfortaa', 'style' => 'bold', 'character'  => 'latin', 'color' => '#333333'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Comfortaa', 'style' => 'bold', 'character'  => 'latin', 'color' => '#333333'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '30px', 'lineheight' => '32px', 'face' => 'Sacramento, cursive', 'style' => 'normal', 'character'  => 'latin', 'color' => '#FFFFFF'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => 'Comfortaa', 'style' => 'bold', 'character'  => 'latin', 'color' => '#292929'));
